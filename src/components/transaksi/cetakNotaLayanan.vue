<template>
    <v-container>
                            ...
                            <td>
                                <v-menu>
                                        ...
                                        <v-list>
                                            ...
                                            <v-list-item>
                                            <v-btn text @click="cetakNotaHandler(item)">Cetak Ulang Nota</v-btn>
                                            </v-list-item>
                                        </v-list>
                                </v-menu>
                            </td>
        ...
        <v-dialog v-model="dialogCetak" persistent max-width="600px">
            <v-card>
                <v-card-title>Nota Lunas Layanan No. {{this.formBayar.kode}}
                    <v-spacer></v-spacer>
...
export default {
    ...
    methods:{
        ...
        cetakNotaHandler(item){
            ...
            this.formBayar.total = item.total_harga,
        ...
        createPDF () {
           ...
           doc.setFontSize(20)
            ...
            for (let i = 0, j = 1; i < this.detailLayanan.length; i++) {
                if(this.detailLayanan[0].layanan.includes('Penitipan')){
            ...
            if(this.count==1){
                ...
                doc.save(this.formBayar.kode + '.pdf');
            }
