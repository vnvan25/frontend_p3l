<template>
    <v-container>
                ...
                class="mt-5">
                    <template v-slot:no-data>
                        <v-alert :value="true" border="left" color="red lighten-2"  dense outlined dark>
                            ...
                            Tidak ada transaksi pengadaan yang sedang menunggu pemesanan
                        </v-alert>
                    </template>
                </v-data-table>
            </div>
                            ...
                            <td>
                                <div>
                                        ...
                                        <v-list>
                                            ...
                                            <v-list-item>
                                                <v-btn text @click="notaHandler(item)">Lihat Surat Pemesanan</v-btn>
                                            </v-list-item>
                                            <v-list-item>
                                                <v-btn text @click="updateJumlahHandler(item)">Konfirmasi Pesanan Datang</v-btn>
                                            </v-list-item>
                                        </v-list>
                                        </v-menu>
                                    </div>
        ...
        <v-dialog v-model="dialog" persistent max-width="600px">
            ...
            <v-card>
                <v-card-title>Surat Pemesanan No. {{this.form.kode}}
                    <v-spacer></v-spacer>
                        <v-btn icon color="red" @click="dialogCetak=false"><v-icon>mdi-close</v-icon></v-btn>
                </v-card-title>
                
                <v-card-actions>
                    <v-btn class="ml-4 mb-4 mt-4" color="primary" @click="cetakNota()">Preview Surat Pemesanan</v-btn>
                    <v-btn class="ml-4 mb-4 mt-4" color="warning" @click="downloadNota()">Download Surat Pemesanan</v-btn>
                </v-card-actions>
            </v-card>
            </v-dialog>
            ...
            <v-card>
                <v-card-title>Konfirmasi Pemesanan No. {{this.form.kode}}
                    <v-spacer></v-spacer>
                        <v-btn icon color="red" @click="dialogKonfirmasi=false"><v-icon>mdi-close</v-icon></v-btn>
                </v-card-title>
...
export default {
    ...
    methods:{
        getData(){
            var uri = this.$apiUrl + '/pengadaan/dataPengadaan?status=Dipesan'
