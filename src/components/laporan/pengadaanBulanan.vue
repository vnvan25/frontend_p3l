<template>
    <v-container>
        <v-card class="pa-md-4 mt-5 mx-lg-auto" max-width="900">
             <h2 class="mb-4 text-center font-weight-black black--text">Laporan Pengadaan Produk Bulanan</h2>
             <v-divider></v-divider>
...
export default {
    ...
    methods:{
        pengadaanData(){
            var uri = this.$apiUrl + '/laporan/pengadaanBulanan?bulan='+this.bulan.id+'&tahun='+this.tahun
        ...
        createPDF () {
            ...
            doc.text(100, 100, 'Laporan Pengadaan Produk Bulanan')
            ...
            doc.setFontStyle("bold")
            doc.text(37, 163, 'No')
            doc.text(80, 163, 'Nama Produk')
            doc.text(250, 163, 'Jumlah Pengeluaran')
            doc.setFontStyle("normal")
