<template>
    <v-container>
        <v-card class="pa-md-4 mt-n12 mx-lg-auto" max-width="900">
             <h2 class="mb-4 text-center font-weight-black black--text">Laporan Pendapatan Bulanan</h2>
             <v-divider></v-divider>
...
export default {
    ...
    methods:{
        layananData(){
            var uri = this.$apiUrl + '/laporan/pendapatanBulananLayanan?bulan='+this.bulan.id+'&tahun='+this.tahun
        ...
        produkData(){
            var uri = this.$apiUrl + '/laporan/pendapatanBulananProduk?bulan='+this.bulan.id+'&tahun='+this.tahun
            this.$http.get(uri).then( (response) =>{
        ...
        createPDF () {
            ...
            doc.text(120, 100, 'Laporan Pendapatan Bulanan')
            doc.setFontStyle("normal")
            
            doc.setFontSize(10)
            doc.text(30, 119, 'Tahun : ' + this.tahun)
            doc.setFontSize(10)
            doc.text(30, 138, 'Bulan : ' + this.bulan.name)
            
            //header
            doc.setFontSize(11)
            doc.setFontStyle("bold")
            doc.text(37, 163, 'No')
            doc.text(80, 163, 'Nama Jasa Layanan')
            doc.text(290, 163, 'Harga')
            doc.setFontStyle("normal")
            ...
            // Empty square
            doc.rect(30, 150, 360, k+18);
            //garis vertikal
            doc.setLineWidth(1);
            doc.line(65, 150, 65, 167+k);
            doc.setLineWidth(1);
            doc.line(275, 150, 275, 167+k);
            ...
            doc.setFontStyle("bold")
            doc.text(37, 50, 'No')
            doc.text(80, 50, 'Nama Produk')
            doc.text(290, 50, 'Harga')
            doc.setFontStyle("normal")
            ...
            //garis horixontal
            doc.setLineWidth(0.5);
            doc.line(30, 58, 390, 58);
            // Empty square
            doc.rect(30, 35, 360, n+18);
            //garis vertikal
            doc.setLineWidth(1);
            doc.line(65, 35, 65, 53+n);
            doc.setLineWidth(1);
            doc.line(275, 35, 275, 53+n);
            ...
            doc.setFontSize(10)
            doc.text("Tanggal Cetak : "+this.tglTransaksi, 391, 200+n, null, null, "right");
            

            doc.setProperties({
                title: "Laporan Pendapatan Bulanan "+ this.bulan.name+" - "+this.tahun
            });
